...
export default {
  ...
  assets: {
    ...
    'submissions/index.html': {size: 53379, hash: '33e9cfa28a3c1396625d9e6501f11d2fb3602725424eff73036057fb7da27f52', text: () => import('./assets-chunks/submissions_index_html.mjs').then(m => m.default)},
